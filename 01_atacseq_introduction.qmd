...
* Fraction of Reads in Peaks (FRiP) score analysis
* Principal component analysis (PCA) plots
* Differential accessibility volcano plots
* Genomic accessibility tracks displayed in genome browsers
* Annotation of accessible regions to genomic features
* Heatmaps of differentially accessible regions
* Integration and correlation analyses between ATAC-seq and RNA-seq datasets
